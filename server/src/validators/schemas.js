...
export const startTestSchema = z.object({ params: idParams, body: z.object({ paragraphId: z.string().regex(/^[a-f\d]{24}$/i), testMode: z.enum(['TCS', 'NTA', 'Standard']).default('Standard') }) });
